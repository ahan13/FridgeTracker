...
namespace FridgeUI.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemNumber,Name,Quantity,DateAdded,Type")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemNumber,Name,Quantity,DateAdded,Type")] Item item)
        {
